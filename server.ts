...
ให้อ่านไฟล์ภาพหรือ PDF ของใบเสร็จนี้ และสกัดข้อมูลออกมาตอบกลับในรูปแบบ JSON เท่านั้น ดังนี้:
{
  ...
  "hasVat": true, // true หากเป็นใบกำกับภาษี, มี Tax ID, มีคำว่า VAT, ภาษีมูลค่าเพิ่ม, 7% หรือเป็นใบเสร็จรับเงินร้านค้าทั่วไป
  "vat": 0.00, // ภาษีมูลค่าเพิ่ม VAT 7% (ถ้าแสดงในใบเสร็จให้ดึงยอดจริง หากไม่แสดงยอดแยกแต่มี VAT หรือเป็นใบเสร็จรับเงิน/ใบกำกับภาษี ให้คำนวณ = round(amount * 7 / 107, 2))
...
2. หากเป็นใบกำกับภาษี, มี Tax ID, มีคำว่า VAT, 7%, ภาษีมูลค่าเพิ่ม, หรือเป็นใบเสร็จรับเงินจากบริษัท/ร้านค้า ให้กำหนด "hasVat": true เสมอ และหากไม่มีแยกยอด vat ไว้ ให้คำนวณ vat = round(amount * 7 / 107, 2)
