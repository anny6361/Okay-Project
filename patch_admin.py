...
user_search_state = r"const \[activeSubTab, setActiveSubTab\] = useState<.*?>(.*?\n"
user_search_state_repl = r"\g<0>  const [userSearchTerm, setUserSearchTerm] = useState('');\n"
content = re.sub(user_search_state, user_search_state_repl, content, count=1)
